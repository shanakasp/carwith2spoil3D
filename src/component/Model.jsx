...
function Model({ color, selectedPart, showSpoiler, ...props }) {
  ...
  useEffect(() => {
    if (nodes[selectedPart]) {
      nodes[selectedPart].material.color.set(color);
    }
  }, [color, selectedPart, nodes]);
      ...
      {showSpoiler && (
        <>
          <mesh
            ...
            position={[-0.761, 5.655, -9.948]}
            scale={[3.715, 0.058, 0.668]}
          />
          <mesh
            geometry={nodes.Object_101.geometry}
            material={materials["Material.003"]}
            position={[-3.461, 4.912, -9.742]}
            scale={[0.085, 0.717, 0.584]}
          />
          <mesh
            geometry={nodes.Object_102.geometry}
            material={materials["Material.003"]}
            position={[1.812, 5.035, -9.638]}
            scale={[0.085, 0.794, 0.566]}
          />
        </>
      )}
    </group>
